<template>
    <v-app class = "contenedor"> <!-- esto es como un div -->
      <!-- Encabezado -->

      <v-app-bar  color = "black" absolute = true class = "barraNav"> 
         <!-- logo - imagen -->
        <img
          alt="Vue logo"
          class="logo"
  ...
  </v-app>  <!-- cerrando div class-->
</template>

<script> // JavaScript para la parte "CONTACTO"
export default{
  data() 
  {
    return{
